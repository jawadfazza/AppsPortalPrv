...
namespace PMD_DAL.Model
{
    ...
    public partial class codePmd2022CommunityCenter
    {
        ...
        [Required(ErrorMessageResourceName = "RequiredField" , ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[StringLength(200, ErrorMessageResourceName = "StringLengthMax", ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[Display(Name = "PMDCommunityCenterFullAddress", ResourceType = typeof(resxDbFields))]
    	public string PMDCommunityCenterFullAddress{ get; set; }
        ...
        public byte[] codePmd2022CommunityCenterRowVersion{ get; set; }
