...
namespace AHD_DAL.Model
{
    ...
    public partial class dataStaffSalaryFlow
    {
        [Required(ErrorMessageResourceName = "RequiredField" , ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[Display(Name = "StaffSalaryFlowGUID", ResourceType = typeof(resxDbFields))]
    	public System.Guid StaffSalaryFlowGUID{ get; set; }
    	
        [Display(Name = "StaffSalaryGUID", ResourceType = typeof(resxDbFields))]
    	public Nullable<System.Guid> StaffSalaryGUID{ get; set; }
        ...
        public byte[] dataStaffSalaryFlowRowVersion{ get; set; }
        ...
        public virtual dataStaffSalary dataStaffSalary { get; set; }
