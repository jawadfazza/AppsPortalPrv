...
namespace TBS_DAL.Model
{
    ...
    public partial class spAuditReport_Result
    {
        ...
        [Required(ErrorMessageResourceName = "RequiredField" , ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[StringLength(307, ErrorMessageResourceName = "StringLengthMax", ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[Display(Name = "ActionDescription", ResourceType = typeof(resxDbFields))]
    	public string ActionDescription{ get; set; }
    	
        [StringLength(257, ErrorMessageResourceName = "StringLengthMax", ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[Display(Name = "jsFunction", ResourceType = typeof(resxDbFields))]
