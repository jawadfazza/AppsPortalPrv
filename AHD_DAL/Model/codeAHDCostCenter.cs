...
namespace AHD_DAL.Model
{
    ...
    public partial class codeAHDCostCenter
    {
        [Required(ErrorMessageResourceName = "RequiredField" , ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[Display(Name = "CostCenterGUID", ResourceType = typeof(resxDbFields))]
    	public System.Guid CostCenterGUID{ get; set; }
    	
        [Display(Name = "CostCenterNumber", ResourceType = typeof(resxDbFields))]
    	...
    	[Display(Name = "dataSalaryCycleRowVersion", ResourceType = typeof(resxDbFields))]
