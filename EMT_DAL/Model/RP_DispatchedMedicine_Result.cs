...
namespace EMT_DAL.Model
{
    ...
    public partial class RP_DispatchedMedicine_Result
    {
        ...
        [Required(ErrorMessageResourceName = "RequiredField" , ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[StringLength(256, ErrorMessageResourceName = "StringLengthMax", ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[Display(Name = "PharmacologicalFormDescription", ResourceType = typeof(resxDbFields))]
    	public string PharmacologicalFormDescription{ get; set; }
