...
(function (root, factory) {
    ...
    var hasMoment = typeof moment === 'function',
        ...
        defaults = {
            ...
            // Theme Classname
            theme: 'triangle-theme date-picker-plugin',
        ...
        renderTitle = function (instance, c, year, month, refYear, randId) {
            ...
            monthHtml = '<div class="pika-label">' + opts.i18n.months[month] + '<select type="month" class="pika-select pika-select-month" tabindex="-1">' + arr.join('') + '</select></div>';
        ...
        renderTimePicker = function (num_options, selected_val, select_class, display_func, increment_by, startHour) {
            increment_by = increment_by || 1;
            var to_return = '<td><select class="pika-select ' + select_class + '">';
            for (var i = startHour; i < num_options; i += increment_by) {
        ...
        renderTime = function (hh, mm, ss, opts) {
            var dir = opts.isRTL ? 'rtl' : 'ltr';
            var to_return = '<table cellpadding="0" cellspacing="0" class="pika-time"><tbody dir="' + dir + '"><tr>' +
                ...
                renderTimePicker(24, hh, 'pika-select-hour', function (i) {
                    ...
                    opts.incrementHourBy, opts.startHour);

            if (opts.showMinutes) {
                to_return += '<td>:</td>' +
                    renderTimePicker(60, mm, 'pika-select-minute', function (i) { if (i < 10) return "0" + i; return i }, opts.incrementMinuteBy, 0);
            }
            ...
            return to_return + '<td><input type="button" class="btn btn-primary btnSetTime" value="Okay"/></td></tr></tbody></table>';
        },
