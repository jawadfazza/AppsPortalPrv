; (function (global, factory) {
    ...
    hooks.defineLocale('ar-iq', {
        ...
        meridiemParse: /ص|م/,
        isPM: function (input) {
            console.log('from moment js: ' + input);
            return 'م' === input;
        },
        meridiem: function (hour, minute, isLower) {
            if (hour < 12) {
    ...
    hooks.defineLocale('ar-tn', {
        months: 'جانفييه_فيفرييه_مارس_أفريل_مي_جوان_جوييه_أوت_سبتمبر_أكتوبر_نوفمبر_ديسمبر'.split('_'),
        monthsShort: 'جانفييه_فيفرييه_مارس_أفريل_مي_جوان_جوييه_أوت_سبتمبر_أكتوبر_نوفمبر_ديسمبر'.split('_'),
        weekdays: 'الأحد_الإثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت'.split('_'),
        weekdaysShort: 'أحد_إثنين_ثلاثاء_أربعاء_خميس_جمعة_سبت'.split('_'),
        weekdaysMin: 'ح_ن_ث_ر_خ_ج_س'.split('_'),
        weekdaysParseExact: true,
