...
namespace SRS_DAL.Model
{
    ...
    public partial class dataAppRequestAuthorization
    {
    	...
    	[NotMapped]
    	[Display(Name = "ApplicationStartDate", ResourceType = typeof(resxDbFields))]
    	public Nullable<System.DateTime> LocalApplicationStartDate { get { return new Portal().LocalTime(this.ApplicationStartDate); } }
    	...
    	[NotMapped]
    	[Display(Name = "ApplicationEndDate", ResourceType = typeof(resxDbFields))]
    	public Nullable<System.DateTime> LocalApplicationEndDate { get { return new Portal().LocalTime(this.ApplicationEndDate); } }
        ...
        public virtual dataApplicationRequest dataApplicationRequest { get; set; }
    }
}
