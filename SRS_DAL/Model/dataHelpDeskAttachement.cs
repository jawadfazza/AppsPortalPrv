...
namespace SRS_DAL.Model
{
    ...
    public partial class dataHelpDeskAttachement
    {
        [Required(ErrorMessageResourceName = "RequiredField" , ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[Display(Name = "HelpDeskAttachementGUID", ResourceType = typeof(resxDbFields))]
    	public System.Guid HelpDeskAttachementGUID{ get; set; }
        ...
        [Required(ErrorMessageResourceName = "RequiredField" , ErrorMessageResourceType = typeof(resxHttpErrors))]
    	[Display(Name = "AttachementPath", ResourceType = typeof(resxDbFields))]
